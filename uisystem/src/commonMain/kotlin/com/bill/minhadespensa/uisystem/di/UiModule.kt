...
package com.bill.minhadespensa.uisystem.di

import com.bill.minhadispensa.core.domain.util.AppLogger
import com.bill.minhadispensa.core.domain.util.ConsoleLogger
import com.bill.minhadespensa.uisystem.features.list.ProductsListViewModel
import org.koin.core.module.dsl.viewModel
import org.koin.core.qualifier.named
import org.koin.dsl.module

val uiModule = module {
    factory<AppLogger>(named("ui_logger")) {
        ConsoleLogger(moduleName = "UISystem")
    }
    viewModel {
        ProductsListViewModel(
            repository = get(),
            logger = get(named("ui_logger"))
        )
    }
}